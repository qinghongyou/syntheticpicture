...
<div id="component">
		<div class="canvas-content">
			<div class="canvas-content-middle">
				<img src="./img/backc.png" class="canvas-content-bg" id="backView">
				<div class="canvas-window">
					<div class="upload-btn">
						<img src="./img/camera.png">
						<div class="upload-hint" style="color:#aa8c5b;font-size:12px;">点击上传图片</div>
						<div style="font-size:12px">建议上传2M以下的照片</div>
